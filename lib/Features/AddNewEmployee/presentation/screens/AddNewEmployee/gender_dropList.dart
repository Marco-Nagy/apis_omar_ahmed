...
class GenderDropList extends StatefulWidget {
  const GenderDropList({Key? key}) : super(key: key);

  @override
  GenderDropListState createState() => GenderDropListState();
}

class GenderDropListState extends State<GenderDropList> {
  @override
    ...
    return Consumer(
      builder: (context, AddEmployeeProvider aep, child) {
        return AnimatedContainer(
          ...
          height: aep.genderIsOpen ? null : 0,
          child: Container(
            height: 200,
