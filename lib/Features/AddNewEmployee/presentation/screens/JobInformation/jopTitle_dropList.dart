...
class JopTitleDropList extends StatefulWidget {
  const JopTitleDropList({Key? key}) : super(key: key);

  @override
  JopTitleDropListState createState() => JopTitleDropListState();
}

class JopTitleDropListState extends State<JopTitleDropList> {
  @override
    ...
    return Consumer(
      builder: (context, AddEmployeeProvider aep, child) {
        return AnimatedContainer(
          ...
          height: aep.jopTitlesOpen ? null : 0,
          child: Container(
            height: 200,
