...
class ReportsToDropList extends StatefulWidget {
  const ReportsToDropList({Key? key}) : super(key: key);

  @override
  ReportsToDropListState createState() => ReportsToDropListState();
}

class ReportsToDropListState extends State<ReportsToDropList> {
  @override
    ...
    return Consumer(
      builder: (context, AddEmployeeProvider aep, child) {
        return AnimatedContainer(
          ...
          height: aep.reportsToIsOpen ? null : 0,
          child: Container(
            height: 200,
                  ...
                  false
                      ...
                      : Expanded(
                          child: ListView.builder(
                            shrinkWrap: aep.reportsToIsOpen,
