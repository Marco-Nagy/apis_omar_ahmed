...
class ContractTypeDropList extends StatefulWidget {
  const ContractTypeDropList({Key? key}) : super(key: key);

  @override
  ContractTypeDropListState createState() => ContractTypeDropListState();
}

class ContractTypeDropListState extends State<ContractTypeDropList> {
  @override
    ...
    return Consumer(
      builder: (context, AddEmployeeProvider aep, child) {
        return AnimatedContainer(
          ...
          height: aep.contractTypeIsOpen ? null : 0,
          child: Container(
            height: 200,
                  ...
                  false
                      ...
                      : Expanded(
                          child: ListView.builder(
                            shrinkWrap: aep.contractTypeIsOpen,
