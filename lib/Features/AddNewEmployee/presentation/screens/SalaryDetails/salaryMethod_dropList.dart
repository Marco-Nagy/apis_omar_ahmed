...
class SalaryMethodDropList extends StatefulWidget {
  const SalaryMethodDropList({Key? key}) : super(key: key);

  @override
  SalaryMethodDropListState createState() => SalaryMethodDropListState();
}

class SalaryMethodDropListState extends State<SalaryMethodDropList> {
  @override
    ...
    return Consumer(
      builder: (context, AddEmployeeProvider aep, child) {
        return AnimatedContainer(
          ...
          height: aep.salaryMethodIsOpen ? null : 0,
          child: Container(
            height: 150,
                  ...
                  false
                      ...
                      : Expanded(
                          child: ListView.builder(
                            shrinkWrap: aep.salaryMethodIsOpen,
