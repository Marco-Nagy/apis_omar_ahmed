import 'package:apis_omar_ahmed/Features/Settings/presentation/screens/SalesExtraCostType/sales_extra_cost_type_dialog.dart';
...
class SalesExtraCostTypeScreen extends StatelessWidget {
  const SalesExtraCostTypeScreen({Key? key}) : super(key: key);
                        ...
                        onTap: () {
                          showDialog(
                              ...
                              builder: (context) => const AlertDialog(
                                    content: SalesExtraCostTypeDialog(),
                                  ));
                        },
                        text: 'Add',
              ...
              itemBuilder: (context, index) {
                return Row(
                  children: [
                    ...
                    const Expanded(
                        flex: 3, child: TableItemCell(text: 'Extra')),
                    const SizedBox(width: 12),
                    SizedBox(
                        width: 85,
