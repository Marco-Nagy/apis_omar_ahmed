...
import 'create_daily_report_through_dialog.dart';

class DailyReportThroughScreen extends StatelessWidget {
  const DailyReportThroughScreen({Key? key}) : super(key: key);
                        ...
                        onTap: () {
                          showDialog(
                              ...
                              builder: (_) => const AlertDialog(
                                  content: CreateDailyReportThroughDialog()));
                        },
                        text: 'Add',
              ...
              itemBuilder: (context, index) {
                return Row(
                  children: [
                    ...
                    const Expanded(
                        flex: 2, child: TableItemCell(text: 'Phone')),
                    const SizedBox(width: 12),
                    const Expanded(
                        flex: 2, child: TableItemCell(text: 'Phone')),
                    const SizedBox(width: 12),
